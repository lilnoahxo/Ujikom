...
<body>
   <div id="hero">
    <div class="container">
        <div class="row align-items-center text-center">
            <div class="col-md-6">
                <h1 class="display-4">Noah's Laundry</h1>
                <p class="mb-5">2 fast for u</p>
                @if(!Auth::guest())
            ...
            <div class="col-md-6">
                <img src="/images/download.jfif" class="img-fluid" alt="">
            </div>
        </div>
    </div>
   </div>
   ...
   <div id="footer">
       <p class="text-center">Copyright lilnoahxo_ 2023</p>
   </div>
</body>
</html>